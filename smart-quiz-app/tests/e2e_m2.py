...
try:
    with sync_playwright() as p:
        ...
        (os.path.isdir(os.environ.get('SQ_SHOTS', 'D:/PLC/s7-200/题库资料/shots')) and pg.screenshot(path=os.path.join(os.environ.get('SQ_SHOTS', 'D:/PLC/s7-200/题库资料/shots'), '10_M2设置深色.png')))
        b.close()
finally:
